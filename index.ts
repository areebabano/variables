...
let teacher: string = "Sir Bilal";
console.log(teacher);

function slot() {
  let student: string = "rubab";
  console.log(student);
  console.log(teacher);
}
slot();
...
let age1: number = 25; //variable age is a number type
console.log(age1);
...
let colors: string[] = ["red","purple","black"]
...
let food = "Tikka"// without type annotation
console.log(food);
